...
import com.example.admin.framework.security.context.AuthenticationContextHolder;
...
import com.example.admin.common.core.domain.model.LoginUser;
import com.example.admin.common.core.redis.RedisCache;
import com.example.admin.common.exception.ServiceException;
import com.example.admin.common.exception.user.BlackListException;
...
import com.example.admin.common.exception.user.UserNotExistsException;
import com.example.admin.common.exception.user.UserPasswordNotMatchException;
import com.example.admin.common.utils.DateUtils;
import com.example.admin.common.utils.MessageUtils;
import com.example.admin.common.utils.StringUtils;
import com.example.admin.common.utils.ip.IpUtils;
...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        try {
            ...
            AuthenticationContextHolder.setContext(authenticationToken);// 通过线程变量方式传递UsernamePasswordAuthenticationToken【包含用户名和密码】到UserDetailsServiceImpl.loadUserByUsername方法中
            authentication = authenticationManager.authenticate(authenticationToken);// 该方法会去调用UserDetailsServiceImpl.loadUserByUsername
        } catch (Exception e) {
